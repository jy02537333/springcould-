package pri.zxw.comutil.convert;
 ...
 * @update date:
 */
public class UtfConvert  extends Reader {
		 ...
		 */
		UtfConvert(InputStream in, String defaultEnc) {
	...
	private static String readContent(String filePath, String encoding) throws Exception {
		...
		BufferedReader br = new BufferedReader(new UtfConvert(file, encoding));
		String line = null;
		String fileContent = "";
	...
	public static void main(String[] args) throws Exception {
		...
		paths = getAllFilePaths(new File("D:\\CodeCreate\\spring_boot\\0329"), paths);
