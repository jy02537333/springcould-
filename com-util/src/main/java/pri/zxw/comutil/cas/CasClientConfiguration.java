...
public class CasClientConfiguration {
	...
	@Bean
	public FilterRegistrationBean casTicketFilter() {
		FilterRegistrationBean registrationBean = new FilterRegistrationBean( new CasTicketFilter(configProps.getIgnorePath(),configProps.getServerUrlPrefix(),configProps.getClientHostUrl()));
		registrationBean.setOrder(1);
		if (this.casClientConfigurer != null) {
			this.casClientConfigurer.configureAuthenticationFilter(registrationBean);
		}
	...
	public FilterRegistrationBean casAuthenticationFilter() {
		...
		final Filter targetCasAuthnFilter =
				(this.configProps.getValidationType() == EnableCasClient.ValidationType.CAS || configProps.getValidationType() == EnableCasClient.ValidationType.CAS3) ? new AuthenticationFilter()
				...
				if(configProps.getIgnorePath()!=null){
					authnFilter.getInitParameters().put("ignorePattern",configProps.getIgnorePath());
				}
